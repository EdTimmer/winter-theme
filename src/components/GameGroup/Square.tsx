...
// Using standard Math.sin for JS-side wobble; no need for three/tsl nodes here
...
const Square = ({
  ...
  // Continuous x-axis wobble around the initial x position
  // Adjust amplitude (0.5) and frequency (0.5) to taste
    groupRef.current.position.x = position[0] + Math.sin(time * 1.5) * 0.5;
