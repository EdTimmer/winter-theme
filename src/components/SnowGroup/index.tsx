    ...
    <group ref={groupRef} position={position} rotation={rotation} scale={scale}>
      ...
      {count >= 1 && (
        <group position={[0, 0, 20]} rotation={[0, 0, Math.PI / 6]} >
          ...
          <SnowflakeA position={[hexPositions[3][0] + getRandomOffset(), hexPositions[3][1] + getRandomOffset(), hexPositions[3][2] + getRandomOffset()]} rotation={[0, 0, 3]} scale={1.4} />
          ...
          <SnowflakeA position={[hexPositions[5][0] + getRandomOffset(), hexPositions[5][1] + getRandomOffset(), hexPositions[5][2] + getRandomOffset()]} rotation={[0, 0, 4]} scale={1.4} />
        </group>
        )
      }
