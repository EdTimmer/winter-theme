...
import vertexShader from '../../../public/assets/shaders/one/vertex-shader.glsl?raw';
import fragmentShader from '../../../public/assets/shaders/one/fragment-shader.glsl?raw';
...
const SnowflakeA = ({ scale = 1, position = [0, 0, 0], rotation = [0, 0, 0] }: Props) => {
  const groupRef = useRef<THREE.Group>(null);
  const { nodes } = useGLTF('/assets/models/snowflake_3.glb'); 
