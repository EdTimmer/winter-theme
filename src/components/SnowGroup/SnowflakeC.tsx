...
import vertexShader from '../../../public/assets/shaders/three/vertex-shader.glsl?raw';
import fragmentShader from '../../../public/assets/shaders/three/fragment-shader.glsl?raw';
...
const SnowflakeC = ({ scale = 1, position = [0, 0, 0], rotation = [0, 0, 0] }: Props) => {
  const groupRef = useRef<THREE.Group>(null);
  const { nodes } = useGLTF('../public/assets/models/snowflake_12.glb'); 
